...
//bool table::read(const char* url)
//{
	//struct reader : public io::reader
	//{
	//	table&	tb;
	//	void*	row;
	...
	//		{
	//			int id = bstag(e.name);
	//			auto p = tb.columns.find(id);
	//			if(p)
	//				tb.set(row, *p, value);
	//		}
	//	}

	//	reader(table& tb) :tb(tb), row(0)
	//	{
	//	}
...
//bool table::write(const char* url)
//{
	//auto pp = io::plugin::find(szext(url));
	//if(!pp)
	//	return false;
	...
	//{
	//	pw->open("element", Structure);
	//	const void* p = rows.get(i);
	//	for(auto& e : columns)
	//	{
	//		char temp[512];
	//		int v;
	...
	//		{
	//		case Text:
	//			if(get(p, e, temp) && temp[0])
	//				pw->set(pn, temp, e.type);
	//			break;
	//		default:
	//			v = get(p, e);
	//			if(v)
