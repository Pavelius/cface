...
extern "C" void qsort(void *base, unsigned num, unsigned width, int(*comp)(const void *, const void *))
{
...
extern "C" void* bsearch(const void *key, const void *base0, unsigned nmemb, unsigned size, int(*compar)(const void*, const void*))
{
